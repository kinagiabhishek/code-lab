...
public class LeetCode570_ManagersWithAtLeast5DirectReports {
    ...
    public static void main(String[] args) {
        LeetCode570_ManagersWithAtLeast5DirectReports solver = new LeetCode570_ManagersWithAtLeast5DirectReports();
