// https://leetcode.com/problems/problem-linkedlist-272/
package linked_lists;

import java.util.*;

public class LeetCode272_LinkedListProblem272 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode272_LinkedListProblem272 solver = new LeetCode272_LinkedListProblem272();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode272_LinkedListProblem272 Passed!");
    }
}
