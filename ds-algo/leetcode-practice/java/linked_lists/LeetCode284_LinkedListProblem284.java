// https://leetcode.com/problems/problem-linkedlist-284/
package linked_lists;

import java.util.*;

public class LeetCode284_LinkedListProblem284 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode284_LinkedListProblem284 solver = new LeetCode284_LinkedListProblem284();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode284_LinkedListProblem284 Passed!");
    }
}
