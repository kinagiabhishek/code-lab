// https://leetcode.com/problems/problem-linkedlist-265/
package linked_lists;

import java.util.*;

public class LeetCode265_LinkedListProblem265 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode265_LinkedListProblem265 solver = new LeetCode265_LinkedListProblem265();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode265_LinkedListProblem265 Passed!");
    }
}
