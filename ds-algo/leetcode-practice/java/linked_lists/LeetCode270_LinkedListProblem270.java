// https://leetcode.com/problems/problem-linkedlist-270/
package linked_lists;

import java.util.*;

public class LeetCode270_LinkedListProblem270 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode270_LinkedListProblem270 solver = new LeetCode270_LinkedListProblem270();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode270_LinkedListProblem270 Passed!");
    }
}
