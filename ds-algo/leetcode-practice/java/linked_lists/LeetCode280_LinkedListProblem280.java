// https://leetcode.com/problems/problem-linkedlist-280/
package linked_lists;

import java.util.*;

public class LeetCode280_LinkedListProblem280 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode280_LinkedListProblem280 solver = new LeetCode280_LinkedListProblem280();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode280_LinkedListProblem280 Passed!");
    }
}
