// https://leetcode.com/problems/problem-linkedlist-268/
package linked_lists;

import java.util.*;

public class LeetCode268_LinkedListProblem268 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode268_LinkedListProblem268 solver = new LeetCode268_LinkedListProblem268();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode268_LinkedListProblem268 Passed!");
    }
}
