// https://leetcode.com/problems/problem-linkedlist-264/
package linked_lists;

import java.util.*;

public class LeetCode264_LinkedListProblem264 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode264_LinkedListProblem264 solver = new LeetCode264_LinkedListProblem264();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode264_LinkedListProblem264 Passed!");
    }
}
