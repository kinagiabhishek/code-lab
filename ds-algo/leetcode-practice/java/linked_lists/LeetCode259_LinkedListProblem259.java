// https://leetcode.com/problems/problem-linkedlist-259/
package linked_lists;

import java.util.*;

public class LeetCode259_LinkedListProblem259 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode259_LinkedListProblem259 solver = new LeetCode259_LinkedListProblem259();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode259_LinkedListProblem259 Passed!");
    }
}
