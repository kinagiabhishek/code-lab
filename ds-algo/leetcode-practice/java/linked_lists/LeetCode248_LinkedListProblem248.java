// https://leetcode.com/problems/problem-linkedlist-248/
package linked_lists;

import java.util.*;

public class LeetCode248_LinkedListProblem248 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode248_LinkedListProblem248 solver = new LeetCode248_LinkedListProblem248();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode248_LinkedListProblem248 Passed!");
    }
}
