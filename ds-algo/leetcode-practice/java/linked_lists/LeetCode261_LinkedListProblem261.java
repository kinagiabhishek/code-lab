// https://leetcode.com/problems/problem-linkedlist-261/
package linked_lists;

import java.util.*;

public class LeetCode261_LinkedListProblem261 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode261_LinkedListProblem261 solver = new LeetCode261_LinkedListProblem261();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode261_LinkedListProblem261 Passed!");
    }
}
