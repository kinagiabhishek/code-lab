// https://leetcode.com/problems/problem-linkedlist-266/
package linked_lists;

import java.util.*;

public class LeetCode266_LinkedListProblem266 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode266_LinkedListProblem266 solver = new LeetCode266_LinkedListProblem266();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode266_LinkedListProblem266 Passed!");
    }
}
