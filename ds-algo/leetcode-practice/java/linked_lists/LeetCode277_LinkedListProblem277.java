// https://leetcode.com/problems/problem-linkedlist-277/
package linked_lists;

import java.util.*;

public class LeetCode277_LinkedListProblem277 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode277_LinkedListProblem277 solver = new LeetCode277_LinkedListProblem277();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode277_LinkedListProblem277 Passed!");
    }
}
