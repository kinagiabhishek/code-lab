// https://leetcode.com/problems/problem-linkedlist-263/
package linked_lists;

import java.util.*;

public class LeetCode263_LinkedListProblem263 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode263_LinkedListProblem263 solver = new LeetCode263_LinkedListProblem263();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode263_LinkedListProblem263 Passed!");
    }
}
