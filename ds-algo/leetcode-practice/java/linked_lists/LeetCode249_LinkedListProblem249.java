// https://leetcode.com/problems/problem-linkedlist-249/
package linked_lists;

import java.util.*;

public class LeetCode249_LinkedListProblem249 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode249_LinkedListProblem249 solver = new LeetCode249_LinkedListProblem249();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode249_LinkedListProblem249 Passed!");
    }
}
