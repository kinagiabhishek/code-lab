// https://leetcode.com/problems/problem-linkedlist-252/
package linked_lists;

import java.util.*;

public class LeetCode252_LinkedListProblem252 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode252_LinkedListProblem252 solver = new LeetCode252_LinkedListProblem252();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode252_LinkedListProblem252 Passed!");
    }
}
