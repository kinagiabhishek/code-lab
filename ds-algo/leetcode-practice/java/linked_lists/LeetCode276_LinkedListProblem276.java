// https://leetcode.com/problems/problem-linkedlist-276/
package linked_lists;

import java.util.*;

public class LeetCode276_LinkedListProblem276 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode276_LinkedListProblem276 solver = new LeetCode276_LinkedListProblem276();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode276_LinkedListProblem276 Passed!");
    }
}
