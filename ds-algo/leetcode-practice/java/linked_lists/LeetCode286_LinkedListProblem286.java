// https://leetcode.com/problems/problem-linkedlist-286/
package linked_lists;

import java.util.*;

public class LeetCode286_LinkedListProblem286 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode286_LinkedListProblem286 solver = new LeetCode286_LinkedListProblem286();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode286_LinkedListProblem286 Passed!");
    }
}
