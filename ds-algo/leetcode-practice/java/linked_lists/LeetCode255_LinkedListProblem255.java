// https://leetcode.com/problems/problem-linkedlist-255/
package linked_lists;

import java.util.*;

public class LeetCode255_LinkedListProblem255 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode255_LinkedListProblem255 solver = new LeetCode255_LinkedListProblem255();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode255_LinkedListProblem255 Passed!");
    }
}
