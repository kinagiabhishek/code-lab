// https://leetcode.com/problems/problem-linkedlist-260/
package linked_lists;

import java.util.*;

public class LeetCode260_LinkedListProblem260 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode260_LinkedListProblem260 solver = new LeetCode260_LinkedListProblem260();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode260_LinkedListProblem260 Passed!");
    }
}
