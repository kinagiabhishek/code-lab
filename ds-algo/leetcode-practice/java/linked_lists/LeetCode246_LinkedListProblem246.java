// https://leetcode.com/problems/problem-linkedlist-246/
package linked_lists;

import java.util.*;

public class LeetCode246_LinkedListProblem246 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode246_LinkedListProblem246 solver = new LeetCode246_LinkedListProblem246();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode246_LinkedListProblem246 Passed!");
    }
}
