// https://leetcode.com/problems/problem-linkedlist-267/
package linked_lists;

import java.util.*;

public class LeetCode267_LinkedListProblem267 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode267_LinkedListProblem267 solver = new LeetCode267_LinkedListProblem267();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode267_LinkedListProblem267 Passed!");
    }
}
