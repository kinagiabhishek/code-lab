// https://leetcode.com/problems/problem-linkedlist-250/
package linked_lists;

import java.util.*;

public class LeetCode250_LinkedListProblem250 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode250_LinkedListProblem250 solver = new LeetCode250_LinkedListProblem250();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode250_LinkedListProblem250 Passed!");
    }
}
