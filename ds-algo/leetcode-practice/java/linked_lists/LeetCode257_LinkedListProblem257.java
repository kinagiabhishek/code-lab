// https://leetcode.com/problems/problem-linkedlist-257/
package linked_lists;

import java.util.*;

public class LeetCode257_LinkedListProblem257 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode257_LinkedListProblem257 solver = new LeetCode257_LinkedListProblem257();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode257_LinkedListProblem257 Passed!");
    }
}
