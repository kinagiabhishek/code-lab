// https://leetcode.com/problems/problem-linkedlist-254/
package linked_lists;

import java.util.*;

public class LeetCode254_LinkedListProblem254 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode254_LinkedListProblem254 solver = new LeetCode254_LinkedListProblem254();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode254_LinkedListProblem254 Passed!");
    }
}
