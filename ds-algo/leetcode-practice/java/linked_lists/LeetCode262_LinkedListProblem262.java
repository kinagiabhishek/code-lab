// https://leetcode.com/problems/problem-linkedlist-262/
package linked_lists;

import java.util.*;

public class LeetCode262_LinkedListProblem262 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode262_LinkedListProblem262 solver = new LeetCode262_LinkedListProblem262();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode262_LinkedListProblem262 Passed!");
    }
}
