// https://leetcode.com/problems/problem-linkedlist-279/
package linked_lists;

import java.util.*;

public class LeetCode279_LinkedListProblem279 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode279_LinkedListProblem279 solver = new LeetCode279_LinkedListProblem279();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode279_LinkedListProblem279 Passed!");
    }
}
