// https://leetcode.com/problems/problem-linkedlist-282/
package linked_lists;

import java.util.*;

public class LeetCode282_LinkedListProblem282 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode282_LinkedListProblem282 solver = new LeetCode282_LinkedListProblem282();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode282_LinkedListProblem282 Passed!");
    }
}
