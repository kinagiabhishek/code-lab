// https://leetcode.com/problems/problem-linkedlist-289/
package linked_lists;

import java.util.*;

public class LeetCode289_LinkedListProblem289 {
    ...
    public static void main(String[] args) {
        ...
        LeetCode289_LinkedListProblem289 solver = new LeetCode289_LinkedListProblem289();
        assert solver.solve(head).val == 2;
        System.out.println("✅ LeetCode289_LinkedListProblem289 Passed!");
    }
}
