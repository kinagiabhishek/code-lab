...
public class LeetCode329_LongestIncreasingPathInAMatrix {
    ...
    public static void main(String[] args) {
        LeetCode329_LongestIncreasingPathInAMatrix solver = new LeetCode329_LongestIncreasingPathInAMatrix();
