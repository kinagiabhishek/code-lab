...
public class LeetCode467_UniqueSubstringsInWraparoundString {
    ...
    public static void main(String[] args) {
        LeetCode467_UniqueSubstringsInWraparoundString solver = new LeetCode467_UniqueSubstringsInWraparoundString();
